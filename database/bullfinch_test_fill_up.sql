...
VALUES ('alex@example.com', 'alex', 'e43713ad9e2fc4c55c1e2b373d3f548bd1ffed6e',
        'Alex', 'Black', '375251111111', 0, 1, 2, 1);
INSERT INTO bullfinch_test.user_account (email, login, password, first_name, second_name, phone_number,
                                         is_blocked, is_activated, role_id_fk, wallet_id_fk)
VALUES ('alexey@example.com', 'alexey', 'e43713ad9e2fc4c55c1e2b373d3f548bd1ffed6e',
        'Alexey', 'White', '80291234567', 0, 0, 2, 2);
INSERT INTO bullfinch_test.user_account (email, login, password, first_name, second_name, phone_number,
                                         is_blocked, is_activated, role_id_fk, wallet_id_fk)
VALUES ('oleg@example.com', 'oleg', 'e43713ad9e2fc4c55c1e2b373d3f548bd1ffed6e',
        'Oleg', 'Brown', '+375337654321', 0, 1, 2, 3);
...
INSERT INTO bullfinch_test.discount (percent, user_account_id_fk)
VALUES (50, 2);
INSERT INTO bullfinch_test.discount (percent, user_account_id_fk)
VALUES (10, 2);
INSERT INTO bullfinch_test.discount (percent, user_account_id_fk)
