...
public class UserDaoImpl implements UserDao {
    ...
    private static final String FIND_BY_LOGIN = "SELECT user_account_id, email, " +
            ...
            "is_activated, wallet_id, balance, role_name FROM user_account " +
    ...
    private static final String BLOCK = "UPDATE user_account SET is_blocked = 1 " +
    ...
    public boolean add(User user, String password, Connection connection)
            throws DaoException {// TODO: 16.09.2020 refactor
