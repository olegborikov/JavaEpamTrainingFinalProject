...
/**
 * The {@code UnarchiveTattooCommand} class represents unarchive tattoo command.
 *
 * @author Oleg Borikov
 * @version 1.0
 */
    ...
    public String execute(HttpServletRequest request) {
        ...
        try {
            if (tattooService.unarchiveTattoo(tattooId)) {
                ...
                request.setAttribute(RequestAttribute.TATTOO_UNARCHIVE_ERROR_MESSAGE, true);
                page = PagePath.MESSAGE;
            }
        } catch (ServiceException e) {
            LOGGER.log(Level.ERROR, "Error while unarchiving tattoo", e);
