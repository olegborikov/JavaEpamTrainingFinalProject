    ...
    public String execute(HttpServletRequest request) {
        ...
        try {
            if (userService.confirmUserEmail(login)) {
                request.setAttribute(RequestAttribute.USER_EMAIL_CONFIRM_POSITIVE_MESSAGE, true);
            } else {
                request.setAttribute(RequestAttribute.USER_EMAIL_CONFIRM_ERROR_MESSAGE, true);
            }
